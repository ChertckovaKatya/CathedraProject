...
CREATE TABLE IF NOT EXISTS `sys_analysis_management`.`SelectedAnswerChoices` (
  ...
  INDEX `fk_SelectedAnswerChoices_PassedTests1_idx` (`idPassedTest` ASC),
  INDEX `fk_SelectedAnswerChoices_Questions1_idx` (`idQuestionPassedTest` ASC),
  INDEX `fk_SelectedAnswerChoices_Answer1_idx` (`idAnswerPassedTest` ASC),
  CONSTRAINT `fk_SelectedAnswerChoices_PassedTests1`
    FOREIGN KEY (`idPassedTest`)
    REFERENCES `sys_analysis_management`.`PassedTests` (`idPassed`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_SelectedAnswerChoices_Questions1`
    FOREIGN KEY (`idQuestionPassedTest`)
    REFERENCES `sys_analysis_management`.`Questions` (`idQuestions`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_SelectedAnswerChoices_Answer1`
    FOREIGN KEY (`idAnswerPassedTest`)
    REFERENCES `sys_analysis_management`.`Answer` (`idAnswer`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

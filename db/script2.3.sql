...
-- -----------------------------------------------------
-- Table `sys_analysis_management`.`SelectedAnswer`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sys_analysis_management`.`SelectedAnswer` (
  ...
  INDEX `fk_SelectedAnswer_Answer1_idx` (`idQuestionPassedTest` ASC),
  CONSTRAINT `fk_SelectedAnswerChoices_PassedTests1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_SelectedAnswer_Answer1`
    FOREIGN KEY (`idQuestionPassedTest`)
    REFERENCES `sys_analysis_management`.`Answer` (`idQuestionAnswer`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
